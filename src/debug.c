...
struct ckmap mechanism_names[] = {
    ...
    MECH_ENTRY(CKM_ML_KEM_KEY_PAIR_GEN),
    ...
    MECH_ENTRY(CKM_ML_KEM),
    MECH_ENTRY(CKM_DSA_SHA3_224),
    MECH_ENTRY(CKM_DSA_SHA3_256),
    MECH_ENTRY(CKM_DSA_SHA3_384),
    MECH_ENTRY(CKM_DSA_SHA3_512),
    MECH_ENTRY(CKM_ML_DSA_KEY_PAIR_GEN),
    MECH_ENTRY(CKM_ML_DSA),
    MECH_ENTRY(CKM_HASH_ML_DSA),
    MECH_ENTRY(CKM_DH_PKCS_KEY_PAIR_GEN),
    MECH_ENTRY(CKM_DH_PKCS_DERIVE),
    MECH_ENTRY(CKM_HASH_ML_DSA_SHA224),
    MECH_ENTRY(CKM_HASH_ML_DSA_SHA256),
    MECH_ENTRY(CKM_HASH_ML_DSA_SHA384),
    MECH_ENTRY(CKM_HASH_ML_DSA_SHA512),
    MECH_ENTRY(CKM_HASH_ML_DSA_SHA3_224),
    MECH_ENTRY(CKM_HASH_ML_DSA_SHA3_256),
    MECH_ENTRY(CKM_HASH_ML_DSA_SHA3_384),
    MECH_ENTRY(CKM_HASH_ML_DSA_SHA3_512),
    MECH_ENTRY(CKM_HASH_ML_DSA_SHAKE128),
    MECH_ENTRY(CKM_HASH_ML_DSA_SHAKE256),
    MECH_ENTRY(CKM_SLH_DSA_KEY_PAIR_GEN),
    MECH_ENTRY(CKM_SLH_DSA),
    ...
    MECH_ENTRY(CKM_HASH_SLH_DSA),
    MECH_ENTRY(CKM_HASH_SLH_DSA_SHA224),
    MECH_ENTRY(CKM_HASH_SLH_DSA_SHA256),
    MECH_ENTRY(CKM_HASH_SLH_DSA_SHA384),
    MECH_ENTRY(CKM_HASH_SLH_DSA_SHA512),
    MECH_ENTRY(CKM_HASH_SLH_DSA_SHA3_224),
    MECH_ENTRY(CKM_HASH_SLH_DSA_SHA3_256),
    MECH_ENTRY(CKM_HASH_SLH_DSA_SHA3_384),
    MECH_ENTRY(CKM_HASH_SLH_DSA_SHA3_512),
    MECH_ENTRY(CKM_HASH_SLH_DSA_SHAKE128),
    MECH_ENTRY(CKM_HASH_SLH_DSA_SHAKE256),
    ...
    MECH_ENTRY(CKM_TLS12_EXTENDED_MASTER_KEY_DERIVE),
    MECH_ENTRY(CKM_TLS12_EXTENDED_MASTER_KEY_DERIVE_DH),
    ...
    MECH_ENTRY(CKM_TLS10_MAC_SERVER),
    MECH_ENTRY(CKM_TLS10_MAC_CLIENT),
    ...
    MECH_ENTRY(CKM_AES_KEY_WRAP_PKCS7),
    ...
    MECH_ENTRY(CKM_IKE2_PRF_PLUS_DERIVE),
    MECH_ENTRY(CKM_IKE_PRF_DERIVE),
    MECH_ENTRY(CKM_IKE1_PRF_DERIVE),
    MECH_ENTRY(CKM_IKE1_EXTENDED_DERIVE),
    MECH_ENTRY(CKM_HSS_KEY_PAIR_GEN),
    MECH_ENTRY(CKM_HSS),
    MECH_ENTRY(CKM_XMSS_KEY_PAIR_GEN),
    MECH_ENTRY(CKM_XMSSMT_KEY_PAIR_GEN),
    MECH_ENTRY(CKM_XMSS),
    MECH_ENTRY(CKM_XMSSMT),
    MECH_ENTRY(CKM_ECDH_X_AES_KEY_WRAP),
    MECH_ENTRY(CKM_ECDH_COF_AES_KEY_WRAP),
    MECH_ENTRY(CKM_PUB_KEY_FROM_PRIV_KEY),
    { 0, NULL },
};
...
struct ckmap mechanism_flags[] = {
    ...
    MECH_ENTRY(CKF_ENCAPSULATE),
    MECH_ENTRY(CKF_DECAPSULATE),
    MECH_ENTRY(CKF_EXTENSION),
    { 0, NULL },
};
...
struct ckmap token_flags[] = {
    ...
    MECH_ENTRY(CKF_SEED_RANDOM_REQUIRED),
    MECH_ENTRY(CKF_ASYNC_SESSION_SUPPORTED),
    { 0, NULL },
};
...
struct ckmap profile_ids[] = {
    ...
    MECH_ENTRY(CKP_COMPLETE_PROVIDER),
    MECH_ENTRY(CKP_HKDF_TLS_TOKEN),
